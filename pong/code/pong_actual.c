...
static time_t start;          /* to store start time for the game*/
...
void status_msg()
{
    ...
    if (*balls_left == 0){
      mvprintw(0,0,"GAME OVER.USED ALL THE BALLS.\tTOTAL TIME: %02lld : %02lld",
	       mins, secs);
    }
    else{
      mvprintw(0,0," BALLS LEFT: %d \t TOTAL TIME: %02lld : %02lld",
